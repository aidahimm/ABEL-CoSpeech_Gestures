...
for epoch in range(num_epochs):
    ...
    # Save checkpoint
    torch.save(netG.state_dict(), f'/Volumes/NO NAME/ABEL-body-motion/gan3_models/generator.pth')
    torch.save(netD.state_dict(), f'/Volumes/NO NAME/ABEL-body-motion/gan3_models/discriminator.pth')

metrics_dir = '/Volumes/NO NAME/ABEL-body-motion/gan3_models'
